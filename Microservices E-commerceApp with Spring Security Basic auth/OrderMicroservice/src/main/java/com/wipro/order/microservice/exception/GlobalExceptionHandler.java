...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleRestClientException(RestClientException ex) {
        ...
        error.put("error", "Microservice Communication Failed");
        error.put("message", "Customer or Product service is not available, or the given customer/product ID does not exist");
    ...
    public ResponseEntity<Map<String, Object>> handleDataIntegrityViolationException(DataIntegrityViolationException ex) {
        ...
        error.put("message", "Order ID already exists or invalid database value");
